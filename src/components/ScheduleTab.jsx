              ...
              return (
                ...
                >
                  ...
                  {isAdmin && hoverSlot?.date === date ? (
                    <div style={{ position: "absolute", left: 0, right: 0, top: ((hoverSlot.minute - DAY_START_HOUR * 60) / 60) * HOUR_PX, height: HOUR_PX / 2, background: "rgba(99,102,241,.14)", pointerEvents: "none", zIndex: 2 }} />
                  ) : null}
                  {Array.from(
                    { length: DAY_END_HOUR - DAY_START_HOUR + 1 },
                    (_, i) => (
