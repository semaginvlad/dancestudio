      ...
      <div style={{ minWidth: 980 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: `70px repeat(7, 1fr)`, position: "relative", minHeight: gridHeight }}>
          <div style={{ position: "relative", borderRight: `1px solid ${theme.border}` }}>
            {Array.from({ length: DAY_END_HOUR - DAY_START_HOUR + 1 }, (_, i) => DAY_START_HOUR + i).map((h, i) => <div key={h} style={{ position: "absolute", top: i * HOUR_PX - 8, left: 8, fontSize: 11, color: theme.textLight }}>{String(h).padStart(2, "0")}:00</div>)}
          </div>
