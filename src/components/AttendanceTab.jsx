  ...
  const getRecordsForCell = (student, dateStr) => {
    ...
    if (isDebugCase) {
      const candidateRows = attn
        ...
        .map((a) => {
          const matchesStudent = sameStudentByRecord(a, student);
          const matchesDate = toDateKey(a.date) === toDateKey(dateStr);
          const matchesGroup = String(a.groupId) === String(gid);
          const matchesCell = matchesStudent && matchesDate && matchesGroup;
          return {
            id: a.id,
      ...
      console.log("[AttendanceTab debug] student.id:", student.id);
      console.log("[AttendanceTab debug] gid:", gid);
      console.log("[AttendanceTab debug] dateStr:", dateStr);
      console.table(candidateRows);
      console.log("[AttendanceTab debug] records.length:", records.length);
    }
