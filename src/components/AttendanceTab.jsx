...
export default function AttendanceTab({
  ...
  const restoreCandidates = useMemo(() => {
    ...
    return [...historyStudentIds]
      .filter((studentId) => !linkedStudentIds.has(String(studentId)))
      .map((studentId) => studentsById.get(String(studentId)))
      .filter(Boolean)
      .map((student) => ({ student, hasHistory: true }))
      .sort((a, b) => getDisplayName(a.student).localeCompare(getDisplayName(b.student), "uk"));
