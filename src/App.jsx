...
export default function App() {
  ...
  const loadAllData = async (currentUser = user) => {
    ...
    try {
      ...
      const fetchScheduleCancelledRows = isCurrentAdmin
        ? () => null
      ...
      const [st, gr, scheduleGr, su, at, ca, scheduleCa, sg, wl, ord, warned, tr, trg, dirs, rb] = await Promise.all([
        ...
        safeFetch(db.fetchAttendance), safeFetch(db.fetchCancelled), safeFetch(fetchScheduleCancelledRows), safeFetch(db.fetchStudentGroups),
